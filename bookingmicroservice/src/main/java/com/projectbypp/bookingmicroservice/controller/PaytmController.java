...
import com.projectbypp.bookingmicroservice.model.Paytm;
...
public class PaytmController {
	...
	public String home() {
	 ...
	 @PostMapping(value = "/pgredirect")
	    public ModelAndView getRedirect(@RequestParam(name = "Order_Id") String customerId,
	                                    @RequestParam(name = "Email") String transactionAmount,
	                                    @RequestParam(name = "Price") String orderId) throws Exception {
